    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        Converter<Assertion, Collection<? extends GrantedAuthority>> authoritiesExtractor = assertion -> {
            ...
            List<SimpleGrantedAuthority> userRoles
                    ...
                    .flatMap(Collection::stream)
                    .map(xml -> new SimpleGrantedAuthority("ROLE_" + Objects.requireNonNull(xml.getDOM()).getTextContent()))
                    .toList();
            return userRoles;
        };
        ...
        http
                ...
                .mvcMatchers("/login/saml2/sso/carsonline").permitAll()
                .mvcMatchers("/logout/saml2/slo/carsonline").permitAll()
                .anyRequest().denyAll();
    }
}
